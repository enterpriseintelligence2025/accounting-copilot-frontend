/*
  redux/reducers/invoiceReducers.js
  - Redux reducers handling file uploads, invoice generation and reconciliation state.
  - Each reducer returns a minimal state object used by components to show loading, success or error.
*/
